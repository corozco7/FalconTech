			...
			<div class="main">
				<header>
					<div class="overlay" style="background-color: black;">
						...
						<div class="title" style="background-color: black;">¡Nosotros
							somos</div>
						<div style="margin: 0; padding: 0; background-color: black;"
							class="logo">
							Falcon<span>Tech!</span>
						</div>
						<div class="letter"
							...
							Somos una empresa creada para las personas del mundo, buscamos
							innovar con tecnologia de ultima genereacion el mundo entero.</div>
						<br>

						<div
							style="font-family: Share Tech Mono; font-size: 20px; align-content: center;">Nuestro
							equipo</div>
						<br>
						<div class="name"
							style="font-family: Share Tech Mono; font-size: 20px;">
							Cesar Orozco &nbsp &nbsp Diana Penagos &nbsp &nbsp Saira Puentes
							&nbsp &nbsp Laura Rios</div>

						<div class="avatar">
							<img src="img/cesar.png"> &nbsp &nbsp &nbsp &nbsp <img
								src="img/diana}.png"> &nbsp &nbsp <img src="img/saira.png">
							&nbsp &nbsp &nbsp <img src="img/Laura.png">
						</div>
						<br> <br> <br> <br>
