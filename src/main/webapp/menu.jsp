		...
		<div class="main">
			<header>
				<div class="overlay">
					...
					<h2 class="title">Bienvenidos
					 </h2>
					<h3> Aqui encontraras a un solo click lo mejor en tecnologia <img class= "cursor" src="https://cdn-icons-png.flaticon.com/512/4585/4585053.png"></h3>
					<p class="description">Facilitamos el acceso a todas las personas y compañias de 
					equipos de ultima generación del mundo electronico.
					</p>
