	...
	<div class="container" id="Layer1"
		...
		<div class="navbar">
			<div class="social-bar">
				...
				<a href="https://www.whatsapp.com/" class="icon icon-twitter"
					target="_blank"><img src="img/wa.png"></a> <a
			...
			<div class="main">
				<header>
					<div class="overlay">
						...
						<p class="description">Facilitamos el acceso de equipos de
							ultima generación del mundo electronico a todas las personas y
							compañias del mundo</p>

						<a href="https://www.misiontic2022.gov.co/portal/" class="btn">Mas
							Información</a> <br> <br>
