			...
			<div class="main">
				<header>
					<div class="overlay" style="background-color: black;">
						<h2 class="title">Gestión Ventas</h2>
						<p class="description"></p>
						<form action="Servlet_Ventas" method="post">
							<!-- Falta validacion  -->
							<input type="text" placeholder="Cedula" name="cedula"
								value="${cliente.getDocumento()}"> <input type="text"
								placeholder="Nombre" name="nombre"
								value="${cliente.getNombre()}"> <input type="submit"
								name="confirmar">
							<div class="letras">
								<table>
									<br>
									...
									<tr>
										<td><input type="text" name="codigo1"
											value="${producto1.getCodigo()}"></td>
										<td><input type="submit" name="verificarproducto1"></td>
										<td><input type="text" name="nombre1"
											value="${producto1.getNombre_producto()}"></td>
										<td><input type="text" name="cantidad1"></td>
										<td><input type="text" name="precio1"
											value="${producto1.getPrecio_compra()}"></td>

									</tr>

									<tr>
										<td><input type="text" name="codigo2"
											value="${producto2.getCodigo()}"></td>
										<td><input type="submit" name="verificarproducto2"></td>
										<td><input type="text" name="nombre2"
											value="${producto2.getNombre_producto()}"></td>
										<td><input type="text" name="cantidad2"></td>
										<td><input type="text" name="precio2"
											value="${producto2.getPrecio_compra()}"></td>

									</tr>
									<tr>
										<td><input type="text" name="codigo3"
											value="${producto3.getCodigo()}"></td>
										<td><input type="submit" name="verificarproducto3"></td>
										<td><input type="text" name="nombre3"
											value="${producto3.getNombre_producto()}"></td>
										<td><input type="text" name="cantidad3"></td>
										<td><input type="text" name="precio3"
											value="${producto3.getPrecio_compra()}"></td>

									</tr>

									<tr>
										<td colspan="5"><input type="submit" name="total"
											value="Enviar venta"></td>
									</tr>

								</table>

								<input type="hidden" name="usuario"
									value="${usuario.getDocumento()}">
						</form>
	...
	<div class="links">
		<ul>
			...
			<li><a href="Productos.jsp" style="-i: 0.2s">Producto <img
					src="img/pc.png"></a></li>
			<li class="active"><a href="Ventas.jsp" style="-i: 0.2s">Ventas
