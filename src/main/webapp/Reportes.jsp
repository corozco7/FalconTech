			...
			<div class="main">
				<header>
					...
					<div class="overlay" style="background-color: black;">
						...
						<input class="button" class="listado" type="button"
							name="listadousuarios" value="Listado de usuarios"
							onclick="location.href='ListadoUsuarios.jsp'"> <input
							class="button" class="listado" type="button"
							name="listadoclientes" value="Listado de clientes"
							onclick="location.href='ListadoClientes.jsp'"> <input
							class="button" class="listado" type="button" name="listadoventas"
							value="Ventas por cliente"
							onclick="location.href='VentasCliente.jsp'">
